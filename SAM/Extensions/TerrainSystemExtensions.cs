...
namespace SAM.Extensions
{
    ...
    /// </summary>
    /// <remarks>
    /// (Credit to Dimentox for figuring out how to get importing heightmaps working.)
    /// </remarks>
    public static class TerrainSystemExtensions
    {
        ...
        public static void ApplyHeightMap( this TerrainSystem terrainSystem, Texture2D heightMap )
        {
        ...
        public static Texture2D ExportHeightMap( this TerrainSystem terrainSystem )
        {
            // Retrieve the RenderTexture from the terrain system.
            var hmRenderTexture = ( RenderTexture ) terrainSystem.heightmap;
